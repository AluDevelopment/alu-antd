...
describe('Locale Provider', () => {
  ...
  it('should change locale of Modal.xxx', () => {
    ...
    locales.forEach(locale => {
      ...
      const currentConfirmNode = document.querySelectorAll('.alu-modal-confirm')[
        document.querySelectorAll('.alu-modal-confirm').length - 1
      ];
      let cancelButtonText = currentConfirmNode.querySelectorAll(
        '.alu-btn:not(.alu-btn-primary) span',
      )[0].innerHTML;
      let okButtonText = currentConfirmNode.querySelectorAll('.alu-btn-primary span')[0].innerHTML;
